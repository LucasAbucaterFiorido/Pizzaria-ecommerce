            ...
            <div class="row">
                    ...
                    <div class="container">
                        <div class="row">
                            ...
                            <div class="col-12">
                                ...
                                <span class="titulo_rodape text-center"><h6><i class="ti-location-pin"></i> <u>Venha visitar um dos nossos restaurantes!</u></h6></span>
                ...
                <div class="col-6" style="position: relative;">
                    <form action="" id="" name="" onsubmit="return false;">
                        <span class="titulo_rodape"><h6><i class="ti-email"></i> Receba novas Ofertas e Cupons gratis!</h6></span>
                    ...
                    <div class="pos-contato-rodape">
                        <span class="titulo_rodape"><h6><i class="ti-headphone-alt"></i> Contatos</h6></span>
                        <ul class="">
