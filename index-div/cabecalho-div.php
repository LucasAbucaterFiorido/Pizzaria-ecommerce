                ...
                <div class="row">
                    ...
                    <div class="col-1"> <!-- style="background-color: salmon;"-->
                        ...
                        <a href="#" id="top_logotipo">
                            <img class="pos_logo" src="http://localhost/n7/php/GitHub/Pizzaria-Ecommerce/img/logo/pizzalogo.png">
                        </a>
                    </div>
                        ...
                        <nav class="navbar navbar-expand justify-content-center top_nav">
                            ...
                            <div class="dropdown" style="position: relative;">
                                ...
                                <ul class="dropdown-menu dropdown-menu-dark" aria-labelledby="login-list">
                                    <li class="nav-item">
                                        <a class="nav-link dropdown-item" href="http://localhost/n7/php/GitHub/Pizzaria-Ecommerce/Paginas/Cart/carrinho.php">
                            ...
                            <div class="dropdown">
                                ...
                                <ul class="dropdown-menu dropdown-menu-dark" aria-labelledby="login-list">
                                    ...
                                    <li class="nav-item">
                                        <a class="nav-link dropdown-item" href="http://localhost/n7/php/GitHub/Pizzaria-Ecommerce/adm/controlPanel.php">
