...
$(window).on("load", function()
{
    ...
    $("#telas").load("http://localhost/n7/php/GitHub/Pizzaria-ecommerce/Formularios/Usuario/frm_Usuario.php");
    ...
    {
        $("#telas").load("http://localhost/n7/php/GitHub/Pizzaria-ecommerce/Formularios/Produto/frm_produto.php");
    ...
    {
        $("#telas").load("http://localhost/n7/php/GitHub/Pizzaria-ecommerce/Paginas/Usuario/meusFavoritos.php");
    ...
    {
        $("#telas").load("http://localhost/n7/php/GitHub/Pizzaria-ecommerce/Formularios/Categoria/frm_categoria.php");
    ...
    {
        $("#telas").load("http://localhost/n7/php/GitHub/Pizzaria-ecommerce/Formularios/Cargo/frm_cargo.php");
    ...
    {
        $("#telas").load("http://localhost/n7/php/GitHub/Pizzaria-Ecommerce/Consultas/usuarios.php");
    ...
    {
        $("#telas").load("http://localhost/n7/php/GitHub/Pizzaria-Ecommerce/Consultas/pedidos.php");
    ...
    {
        $("#telas").load("http://localhost/n7/php/GitHub/Pizzaria-Ecommerce/Consultas/produtos.php");
    ...
    {
        $("#telas").load("http://localhost/n7/php/GitHub/Pizzaria-Ecommerce/Consultas/categorias.php");
    ...
    {
        $("#telas").load("http://localhost/n7/php/GitHub/Pizzaria-Ecommerce/Consultas/cargos.php");
